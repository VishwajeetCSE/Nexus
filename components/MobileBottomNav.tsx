...
import { Radio, LifeBuoy, Compass, PlusCircle, Briefcase } from "lucide-react";
...
export default function MobileBottomNav() {
  ...
  return (
    <nav className="sm:hidden fixed bottom-0 left-0 right-0 z-40 bg-slate-950/95 backdrop-blur-lg border-t border-slate-800/80 px-1 py-1.5 flex items-center justify-around shadow-2xl">
      {/* Pulse Feed Tab */}
      <button
      ...
      <button
        ...
        className={`relative flex flex-col items-center gap-1 py-1 px-2.5 rounded-2xl transition-all ${
          activeTab === "sos"
      ...
      <button
        ...
        className="flex flex-col items-center gap-1 py-1 px-2.5 rounded-2xl text-slate-400 hover:text-slate-200 transition-all"
      >
